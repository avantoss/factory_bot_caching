...
Gem::Specification.new do |spec|
  ...
  spec.summary       = "A caching mechanism for test suites using Factory Bot with ActiveRecord."
  spec.description   = %q{The factory_bot_caching gem provides a caching mechanism for Factory Bot to significantly reduce test suite runtimes in factory heavy test suites.}
  spec.license       = "MIT"
